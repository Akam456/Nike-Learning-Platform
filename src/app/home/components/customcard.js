...
const CustomCard = ({ topTitle, title, backgroundImage, rating, tickerProgress }) => {
  return (
    <div className="w-full">
    <h1 className='text-xl font-bold'>{topTitle}</h1>
    <div>
      {/* Card Content */}
      <div
        className="relative w-full h-48 rounded-lg overflow-hidden shadow-lg bg-cover bg-center"
      ...
      >
        ...
        <div className="absolute top-2 right-2 flex items-center">
          ...
          <span className="mx-1 text-sm text-white">{rating}</span>
        </div>
      ...
      {/* Ticker (Thinner and Less Wide Below the Card) */}
      <div className="mt-2">
        <div className="relative w-3/4 h-1 bg-gray-300 rounded-full overflow-hidden mx-auto"> {/* Thinner height (h-1) and narrower width (w-3/4) */}
          <div
