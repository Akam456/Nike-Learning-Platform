    ...
    return (
        <div className="fixed inset-0 w-full h-full bg-black bg-opacity-50 z-50 flex justify-center items-center">
            <div className="bg-black p-4 w-11/12 max-w-6xl h-auto max-h-[90vh] rounded-lg relative">
                ...
                {/* Course Content */}
                <div className="p-4 md:p-8 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-[10%] h-auto">
                    <div className="text-lg text-white leading-[25px] font-helveticaNeue text-[17px] w-full md:w-3/4">
                        {content.description}
                    </div>
                ...
                {/* Levels */}
                <div className="space-x-2 md:space-x-12 ml-4 mr-4 flex md:flex-row justify-center p-2 mt-6">
                    {content.levels.map((level, index) => (
                        ...
                        >
                            <div className="text-white text-3xl md:text-4xl font-semibold relative" style={{ left: '-4.5rem' }}>
                                {level.name}
                            </div>
