  ...
  return (
    <div className="fixed inset-0 w-full h-full bg-black bg-opacity-10 backdrop-blur-[2px] z-50 flex justify-center items-center">
      <div className="bg-white p-4 w-8/12 h-[60vh] rounded-2xl relative border-1">
        ...
        {/* Course Content */}
        <div className="p-4 md:p-8 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
          <div className="flex flex-col">
            ...
            <div className="mt-4">
              ...
              >
                <button className="w-[220px] h-[50px] bg-black text-white text-[22px] font-semibold rounded-md">
                  Begin Learning
